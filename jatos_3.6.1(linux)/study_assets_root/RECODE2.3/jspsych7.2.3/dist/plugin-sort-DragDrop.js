var jsPsychSortDD = (function (jspsych) {
  'use strict';
  ...
  const info = {
      ...
      parameters: {
          ...
          /** Array of objects to put in the bag. */
          bagItems: {
              type: jspsych.ParameterType.IMAGE,
              pretty_name: "Items in bag",
              default: undefined,
              array: true,
          },
          ...
          counter_text_unfinished: {
              ...
              default: "Devi ancora posizionare %n% elementi dentro il sacco.",
          ...
          counter_text_finished: {
              ...
              default: "Hai posizionato tutti gli elementi. Sentiti libero di ripensarci se necessario.",
          },
          /**
  ...
  class SortDDPlugin {
      ...
      trial(display_element, trial) {
          ...
          let html = "<div " +
              ...
              'px; margin: auto; '+
              "background-image: url(./TASKS/LINGUAGGIO/categorizzazione_semantica/img/saccoVuotoFrutta1.jpg);" + 
              "background-size: cover;'>"
          // another div for fixed items
         /* html +=
          ...
          if (trial.sort_area_shape == "ellipse") {
              html += "<div id='jspsych-free-sort-border' class='jspsych-free-sort-border' style='position: relative; width:" +
                  trial.sort_area_width * 0.94 +
                  "px; height:" +
                  trial.sort_area_height * 0.94 +
                  "px; " +
                  ...
                  "px solid " +
                  border_color_out +
                  "; margin: auto; line-height: 0em; webkit-border-radius: 50%; moz-border-radius: 50%; border-radius: 50%'></div>";
          }
          else if (trial.sort_area_shape == "custom"){
            html += "<div " + 
            "style= 'background-image: url(./TASKS/LINGUAGGIO/categorizzazione_semantica/img/saccoVuotoFrutta1.jpg);'" +
            "</div>";
          } 
          else {
            //rettangoli di selezione quanti sono le immagini da inserire
            //html += "<div style='background-image: url('./TASKS/MEMORIA_VISIVA/Drag_Drop/img/saccoVuotoFrutta1.jpg');'"
            html += "<div id='jspsych-free-sort-border' class='jspsych-free-sort-border' style='position: relative; width:" +
                trial.stim_width * 0.94 +
                "px; height:" +
                trial.stim_height * 0.94 +
                "px; " +
                "border:" +
                border_width +
                "px solid " +
                border_color_out +
                "; margin: auto; line-height: 0em; webkit-border-radius: 0%; moz-border-radius: 0%; border-radius: 0%; top: 254px; left: 56px'></div>";
            html += "<div id='jspsych-free-sort-border1' class='jspsych-free-sort-border' style='position: relative; width:" +
                trial.stim_width * 0.94 +
                "px; height:" +
                trial.stim_height * 0.94 +
                "px; " +
                ...
                "px solid " +
                border_color_out +
                "; margin: auto; line-height: 0em; webkit-border-radius: 0%; moz-border-radius: 0%; border-radius: 0%; top: 318px; left: -114px'></div>";
            html += "<div id='jspsych-free-sort-border2' class='jspsych-free-sort-border' style='position: relative; width:" +
                trial.stim_width * 0.94 +
                "px; height:" +
                trial.stim_height * 0.94 +
                "px; " +
                ...
                "px solid " +
                border_color_out +
                "; margin: auto; line-height: 0em; webkit-border-radius: 0%; moz-border-radius: 0%; border-radius: 0%; top: 349.5px; left: 107.5px'></div>";
            html += "<div id='jspsych-free-sort-border3' class='jspsych-free-sort-border' style='position: relative; width:" +
                trial.stim_width * 0.94 +
                "px; height:" +
                trial.stim_height * 0.94 +
                "px; " +
                ...
                "px solid " +
                border_color_out +
                "; margin: auto; line-height: 0em; webkit-border-radius: 0%; moz-border-radius: 0%; border-radius: 0%; top: 373px; left: -94.5px'></div>";
            html += "<div id='jspsych-free-sort-border4' class='jspsych-free-sort-border' style='position: relative; width:" +
                trial.stim_width * 0.94 +
                "px; height:" +
                trial.stim_height * 0.94 +
                "px; " +
                ...
                "px solid " +
                border_color_out +
                "; margin: auto; line-height: 0em; webkit-border-radius: 0%; moz-border-radius: 0%; border-radius: 0%; top: 378px; left: 120px'></div></div></div>";
          
           /* html += "<div style='border-left: 6px solid black; height: 1000px; position:absolute; left: 65; top:0;'></div>"+
                    "<div style='border-left: 6px solid black; height: 1000px; position:absolute; left: 430; top:0;'></div>"+
                    "</div></div>"*/
          }
          // variable that has the prompt text and counter
          //spaziatura tra le istruzioni e il counter
          const html_text = '<div style="line-height: 2.0em;">' +
              trial.prompt +
              '<p id="jspsych-free-sort-counter" style="display: inline-block;">' +
              get_counter_text(trial.numItem) +
              "</p></div>";
          ...
          for (let i = 0; i < stimuli.length; i++) {
              ...
              //disposizione elementi fuori da trascinare dentro 
          ...
          const border1 = display_element.querySelector("#jspsych-free-sort-border1");
          const border2 = display_element.querySelector("#jspsych-free-sort-border2");
          const border3 = display_element.querySelector("#jspsych-free-sort-border3");
          const border4 = display_element.querySelector("#jspsych-free-sort-border4");
          ...
          if (inside.some(Boolean) && trial.change_border_background_color) {
              ...
              border1.style.borderColor = trial.border_color_in;
              border2.style.borderColor = trial.border_color_in;
              border3.style.borderColor = trial.border_color_in;
              border4.style.borderColor = trial.border_color_in;
          }
          
          //if (inside.every(Boolean)) {
          if (inside.every(Boolean)) {
            console.log('END 2 '+ trial.change_border_background_color)
              if (trial.change_border_background_color) {
                  border.style.background = trial.border_color_in;
                  border1.style.background = trial.border_color_in;
                  border2.style.background = trial.border_color_in;
                  border3.style.background = trial.border_color_in;
                  border4.style.background = trial.border_color_in;
              }
          ...
          for (let i = 0; i < draggables.length; i++) {
              draggables[i].addEventListener(start_event_name, (event) => {
                  ...
                  let move_event = (e) => {
                      ...
                      if (trial.change_border_background_color) {
                          if (cur_in) {
                              ...
                              border1.style.borderColor = trial.border_color_in;
                              border1.style.background = "None";
                              border2.style.borderColor = trial.border_color_in;
                              border2.style.background = "None";
                              border3.style.borderColor = trial.border_color_in;
                              border3.style.background = "None";
                              border4.style.borderColor = trial.border_color_in;
                              border4.style.background = "None";
                          }
                          else {
                              border.style.borderColor = border_color_out;
                              border.style.background = "None";
                              border1.style.borderColor = border_color_out;
                              border1.style.background = "None";
                              border2.style.borderColor = border_color_out;
                              border2.style.background = "None";
                              border3.style.borderColor = border_color_out;
                              border3.style.background = "None";
                              border4.style.borderColor = border_color_out;
                              border4.style.background = "None";
                  ...
                  var end_event = (e) => {
                      ...
                      nInside = inside.filter(isTrue); 
                      console.log('cià '+ inside)
                      // modify text and background if all items are inside
                      if (trial.numItem - inside.filter(Boolean).length == 0){ //inside.every(Boolean)) {
                        console.log('END')
                          if (trial.change_border_background_color) {
                              border.style.background = trial.border_color_in;
                              border1.style.background = trial.border_color_in;
                          ...
                          display_element.querySelector("#jspsych-free-sort-counter").innerHTML =
                              get_counter_text(trial.numItem - inside.filter(Boolean).length)//nInside.filter(isTrue).length);//inside.length - inside.filter(Boolean).length);
                      }
          ...
          display_element.querySelector("#jspsych-free-sort-done-btn").addEventListener("click", () => {
              if (nInside.length == trial.numItem) {//inside.every(Boolean)) {
                  const end_time = performance.now();
                  console.log('premuto il tasto FINE')
                  console.log('#jspsych-free-sort-arena ' + display_element.querySelector("#jspsych-free-sort-arena"))
                  const rt = Math.round(end_time - start_time);
                  // gather data
                  var dentroIlSacco = false;
                  console.log('oggetti che devono andare nel sacco ' + trial.bagItems.length)
                  const items = display_element.querySelectorAll(".jspsych-free-sort-draggable");
                  // get final position of all items
                  let final_locations = [];
                  for (let i = 0; i < items.length; i++) {
                    console.log('posizione x di '+ items[i].dataset.src + ' :' + items[i].style.left.split('.')[0].split('px')[0])
                    for (let j = 0; j < init_locations.length; j++) {
                      if (init_locations[i]['src'] == items[i].dataset.src) {
                        if (init_locations[i]['x'].toString().split('.')[0] == items[i].style.left.split('.')[0].split('px')[0]){
                          var dentroIlSacco = false
                          var score = 0
                        } 
                        else if (65 > parseInt(items[i].style.left.split('.')[0].split('px')[0]) || parseInt(items[i].style.left.split('.')[0].split('px')[0]) > 430){
                          var dentroIlSacco = false
                          var score = 0
                        }
                        else {
                          var dentroIlSacco = true
                          if (trial.bagItems.includes(items[i].dataset.src)){
                            var score = 1
                          } else {
                            var score = 0
                          }
