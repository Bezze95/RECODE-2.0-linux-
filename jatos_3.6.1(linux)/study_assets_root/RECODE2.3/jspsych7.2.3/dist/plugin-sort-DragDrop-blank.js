  ...
  class SortDDPlugin {
      ...
      trial(display_element, trial) {
          ...
          let html = "<div " +
              ...
              'px; margin: auto; '+
              "background-image: url(./TASKS/LINGUAGGIO/categorizzazione_semantica/img/saccoVuoto1.jpg);" + 
         ...
         /* html +=
          ...
          if (trial.sort_area_shape == "ellipse") {
            ...
            html += "<div " + 
            "style= 'background-image: url(./TASKS/LINGUAGGIO/categorizzazione_semantica/img/saccoVuoto1.jpg);'" +
            "</div>";
          } 
          else {
