  ...
  class SortDDPlugin {
      ...
      trial(display_element, trial) {
          ...
          let html = "<div " +
              ...
              'px; margin: auto; '+
              "background-image: url(./TASKS/MEMORIA_VISIVA/Drag_Drop/img/saccoVuotoFrutta1.jpg);" + 
         ...
         /* html +=
          ...
          if (trial.sort_area_shape == "ellipse") {
            ...
            html += "<div " + 
            "style= 'background-image: url(./TASKS/MEMORIA_VISIVA/Drag_Drop/img/saccoVuotoFrutta1.jpg);'" +
            "</div>";
          } 
          else {
